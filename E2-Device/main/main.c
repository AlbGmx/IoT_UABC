...
#define PORT 8266
// #define LOCAL_HOST_IP_ADDR "192.168.157.110"  // Local IP
#define HOST_IP_ADDR "192.168.1.70"  // IoT Server
...
void process_command(const char *command, char *response) {
   ...
   const char *prefix2 = "UABC:LAN:";
   if (strncmp(command, prefix, strlen(prefix)) != 0 && strncmp(command, prefix2, strlen(prefix2)) != 0) {
