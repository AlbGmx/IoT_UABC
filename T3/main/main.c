...
/* STA Configuration */
#define EXAMPLE_ESP_WIFI_STA_SSID           "NO-SSID"
#define EXAMPLE_ESP_WIFI_STA_PASSWD         "34567890"
...
esp_netif_t *wifi_init_softap(void)
{
    ...
    wifi_config_t wifi_ap_config = {
        .ap = {
            ...
            .ssid_len = strlen(EXAMPLE_ESP_WIFI_STA_SSID),
