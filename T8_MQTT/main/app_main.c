   ...
   switch ((esp_mqtt_event_id_t)event_id) {
      case MQTT_EVENT_CONNECTED:
         ...
         if (PUBLISHER) {
            ...
            msg_id = esp_mqtt_client_publish(client, "device/led", "1:EGC", 0, 1, 1);
      ...
      case MQTT_EVENT_DATA:
         ...
         // event->property->response_topic); ESP_LOGI(TAG, "correlation_data is %.*s",
         // event->property->correlation_data_len, event->property->correlation_data); ESP_LOGI(TAG, "content_type is
...
static void mqtt5_app_start(void) {
   ...
   esp_mqtt_client_config_t mqtt5_cfg = {
       .broker.address.uri = "mqtt://iot-uabc.site",
